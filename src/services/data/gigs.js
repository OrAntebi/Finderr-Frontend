export const gigsData = [
    ...
    },
    {
        ...
        packages: {
            basic: {
                ...
                packPrice: 20, packDaysToMake: 3,
                desc: '1 logo design, High Quality Mock-up, Logo Transparency',
                features: ['1 concept included', 'Logo transparency']
            },
            standard: {
                title: 'Normal Package',
                packPrice: 30, packDaysToMake: 2,
                desc: '2 HQ logo concepts + 3D Mock up + Logo Transparency + Printable Resolution file',
                features: ['2 concept included', 'Logo transparency', 'Printable file', 'Include 3D mockup']
            },
            premium: {
                title: 'Deluxe Package',
                packPrice: 40, packDaysToMake: 1,
                desc: ' 3 Amazing concepts + all source files+ Social Media Kit + 24/7 priority customer services',
                features: ['3 concepts included', 'Logo transparency', 'Vector file', 'Printable file', 'Include 3D mockup', 'Include source file', 'Include social media kit']
            }
        },
    ...
    },
    {
        ...
        packages: {
            basic: {
                ...
                packPrice: 10, packDaysToMake: 3,
                desc: '1 logo design, High Quality Mock-up, Logo Transparency',
                features: ['1 concept included', 'Logo transparency']
            },
            standard: {
                title: 'VIP Package',
                packPrice: 15, packDaysToMake: 2,
                desc: '2 HQ logo concepts + 3D Mock up + Logo Transparency + Printable Resolution file',
                features: ['2 concept included', 'Logo transparency', 'Printable file', 'Include 3D mockup']
            },
            premium: {
                title: 'Best Package',
                packPrice: 20, packDaysToMake: 1,
                desc: ' 3 Amazing concepts + all source files+ Social Media Kit + 24/7 priority customer services',
                features: ['3 concepts included', 'Logo transparency', 'Vector file', 'Printable file', 'Include 3D mockup', 'Include source file', 'Include social media kit']
            }
        },
    ...
    },
    {
        ...
        packages: {
            basic: {
                ...
                packPrice: 60, packDaysToMake: 4,
                desc: '1 logo design, High Quality Mock-up, Logo Transparency',
                features: ['1 concept included', 'Logo transparency']
            },
            standard: {
                title: 'Professional Package',
                packPrice: 90, packDaysToMake: 3,
                desc: '2 HQ logo concepts + 3D Mock up + Logo Transparency + Printable Resolution file',
                features: ['2 concept included', 'Logo transparency', 'Printable file', 'Include 3D mockup']
            },
            premium: {
                title: 'Diamond Package',
                packPrice: 120, packDaysToMake: 2,
                desc: ' 3 Amazing concepts + all source files+ Social Media Kit + 24/7 priority customer services',
                features: ['3 concepts included', 'Logo transparency', 'Vector file', 'Printable file', 'Include 3D mockup', 'Include source file', 'Include social media kit']
            }
        },
    ...
    },
    {
        ...
        packages: {
            basic: {
                title: 'Basic',
                packPrice: 70, packDaysToMake: 1,
                desc: 'Single page Frontend website (Static).',
                features: ['1 page', 'Content upload', 'Responsive design', 'Design customization']
            },
            standard: {
                title: 'Standard',
                packPrice: 105, packDaysToMake: 1,
                desc: 'Major frontend website',
                features: ['3 pages', 'Content upload', 'Responsive design', 'Design customization', 'Source code']
            },
            premium: {
                title: 'Premium',
                packPrice: 140, packDaysToMake: 1,
                desc: 'FullStack website',
                features: ['5 pages', 'Content upload', 'Responsive design', 'Design customization', 'Backend', 'Custom admin panel', 'Server upload']
            }
        },
    ...
    },
    {
        ...
        packages: {
            basic: {
                title: 'Basic',
                packPrice: 80, packDaysToMake: 1,
                desc: 'Single page Frontend website (Static).',
                features: ['1 page', 'Content upload', 'Responsive design', 'Design customization']
            },
            standard: {
                title: 'Standard',
                packPrice: 120, packDaysToMake: 1,
                desc: 'Major frontend website',
                features: ['3 pages', 'Content upload', 'Responsive design', 'Design customization', 'Source code']
            },
            premium: {
                title: 'Premium',
                packPrice: 160, packDaysToMake: 1,
                desc: 'FullStack website',
                features: ['5 pages', 'Content upload', 'Responsive design', 'Design customization', 'Backend', 'Custom admin panel', 'Server upload']
            }
        },
    ...
    },
    {
        ...
        packages: {
            basic: {
                title: 'Small Project ',
                packPrice: 100, packDaysToMake: 2,
            ...
            standard: {
                ...
                packPrice: 150, packDaysToMake: 1,
            ...
            premium: {
                title: 'Large Project',
                packPrice: 200, packDaysToMake: 1,
    ...
    },
    {
        ...
        packages: {
            basic: {
                title: 'Cheap Package',
                packPrice: 25, packDaysToMake: 6,
                desc: '1 logo design, High Quality Mock-up, Logo Transparency',
                features: ['1 concept included', 'Logo transparency']
            },
            standard: {
                title: 'Standard Package',
                packPrice: 38, packDaysToMake: 5,
                desc: '2 HQ logo concepts + 3D Mock up + Logo Transparency + Printable Resolution file',
                features: ['2 concept included', 'Logo transparency', 'Printable file', 'Include 3D mockup']
            },
            premium: {
                title: 'HIGH QUALITY',
                packPrice: 50, packDaysToMake: 4,
                desc: ' 3 Amazing concepts + all source files+ Social Media Kit + 24/7 priority customer services',
                features: ['3 concepts included', 'Logo transparency', 'Vector file', 'Printable file', 'Include 3D mockup', 'Include source file', 'Include social media kit']
            }
        },
    ...
    },
    {
        ...
        packages: {
            ...
            premium: {
                ...
                packPrice: 140, packDaysToMake: 3,
    ...
    },
    {
        ...
        packages: {
            basic: {
                title: 'Basic',
                packPrice: 245, packDaysToMake: 10,
    ...
    },
    {
        ...
        packages: {
            basic: {
                title: 'Bronze',
                packPrice: 130, packDaysToMake: 3,
            ...
            standard: {
                title: 'Silver',
                packPrice: 195, packDaysToMake: 2,
            ...
            premium: {
                title: 'Gold',
                packPrice: 260, packDaysToMake: 1,
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Growth", packPrice: 210, packDaysToMake: 3, desc: "Full 3-statement model", features: ["Excel model", "Cash-flow"] },
            premium: { title: "Investor", packPrice: 280, packDaysToMake: 2, desc: "Audit-ready pack", features: ["Notes", "Ratio analysis", "Revisions"] }
        },
        owner: {
            _id: "finU1",
            fullname: "Faz",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Plus", packPrice: 270, packDaysToMake: 2, desc: "3-statement linked model", features: ["3 scenarios", "Charts"] },
            premium: { title: "Pro", packPrice: 360, packDaysToMake: 1, desc: "Investor deck ready", features: ["DCF valuation", "Sensitivity"] }
        },
        owner: {
            _id: "finU2",
            fullname: "Yahya T",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "2 Accounts", packPrice: 143, packDaysToMake: 1, desc: "Up to 500 transactions", features: ["QuickBooks", "Report"] },
            premium: { title: "Multi", packPrice: 190, packDaysToMake: 1, desc: "Unlimited transactions", features: ["QuickBooks", "Xero", "Report"] }
        },
        owner: {
            _id: "finU3",
            fullname: "Abdul R",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Deep", packPrice: 165, packDaysToMake: 1, desc: "Asset allocation plan", features: ["Excel", "Recommendations"] },
            premium: { title: "Premium", packPrice: 220, packDaysToMake: 1, desc: "Ongoing quarterly review", features: ["Follow-up call"] }
        },
        owner: {
            _id: "finU4",
            fullname: "Brenn K",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Planner", packPrice: 90, packDaysToMake: 1, desc: "Annual forecast", features: ["Debt payoff plan"] },
            premium: { title: "Coach", packPrice: 120, packDaysToMake: 1, desc: "1-on-1 session", features: ["Saving goals", "Follow-up"] }
        },
        owner: {
            _id: "finU5",
            fullname: "Md Al Amin",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Support Bot", packPrice: 375, packDaysToMake: 3, desc: "CRM integration", features: ["3 data sources", "Brand tone"] },
            premium: { title: "AI Assistant", packPrice: 500, packDaysToMake: 2, desc: "Advanced RAG + analytics", features: ["Vector DB", "Dashboard"] }
        },
        owner: {
            _id: "aiU1",
            fullname: "Mominul H",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "10 Images", packPrice: 98, packDaysToMake: 1, desc: "Multiple concepts", features: ["Prompt sheet"] },
            premium: { title: "20 Images", packPrice: 130, packDaysToMake: 1, desc: "Full campaign set", features: ["PSD files", "Variations"] }
        },
        owner: {
            _id: "aiU2",
            fullname: "Shovon",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Pro", packPrice: 900, packDaysToMake: 4, desc: "Up to 200 MB data", features: ["LoRA", "TensorBoard"] },
            premium: { title: "Enterprise", packPrice: 1200, packDaysToMake: 3, desc: "1 GB data + deployment", features: ["GPU training", "Docker image"] }
        },
        owner: {
            _id: "aiU3",
            fullname: "Maudud",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "5k rows", packPrice: 135, packDaysToMake: 2, desc: "Multi-class labels", features: ["Quality audit"] },
            premium: { title: "10k rows", packPrice: 180, packDaysToMake: 1, desc: "Complex annotation", features: ["NER", "Relations"] }
        },
        owner: {
            _id: "aiU4",
            fullname: "Fendi",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Suite", packPrice: 113, packDaysToMake: 1, desc: "Multi-sheet", features: ["Power Query", "Docs"] },
            premium: { title: "Full BI", packPrice: 150, packDaysToMake: 1, desc: "Power BI + GPT", features: ["Dashboard", "Training"] }
        },
        owner: {
            _id: "aiU5",
            fullname: "Fiday",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Plus", packPrice: 68, packDaysToMake: 1, desc: "Daily accountability", features: ["Chat support"] },
            premium: { title: "VIP", packPrice: 90, packDaysToMake: 1, desc: "Voice coaching", features: ["Weekly calls"] }
        },
        owner: {
            _id: "pgU1",
            fullname: "Christoph",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Deep Calm", packPrice: 45, packDaysToMake: 1, desc: "20-min routine", features: ["Audio tracks"] },
            premium: { title: "Zen Path", packPrice: 60, packDaysToMake: 1, desc: "40-min routine", features: ["Live session"] }
        },
        owner: {
            _id: "pgU2",
            fullname: "Karen R",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Focus", packPrice: 105, packDaysToMake: 1, desc: "1-hr Zoom coaching", features: ["Action plan"] },
            premium: { title: "Breakthrough", packPrice: 140, packDaysToMake: 1, desc: "3 coaching calls", features: ["Ongoing support"] }
        },
        owner: {
            _id: "pgU3",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Action", packPrice: 300, packDaysToMake: 2, desc: "Roadmap", features: ["Call", "2 revisions"] },
            premium: { title: "Scale", packPrice: 400, packDaysToMake: 1, desc: "Growth plan", features: ["3 calls", "Investor deck"] }
        },
        owner: {
            _id: "conU1",
            fullname: "Nidhi",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "1-hr Call", packPrice: 135, packDaysToMake: 1, desc: "Live coaching", features: ["Recording"] },
            premium: { title: "Package", packPrice: 180, packDaysToMake: 1, desc: "Rate sheet + call", features: ["Follow-up"] }
        },
        owner: {
            _id: "conU2",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Standard", packPrice: 375, packDaysToMake: 4, desc: "10 interviews", features: ["Transcripts", "Insights"] },
            premium: { title: "Full", packPrice: 500, packDaysToMake: 3, desc: "20 interviews", features: ["Video clips", "Deck"] }
        },
        owner: {
            _id: "conU3",
            fullname: "Omar S",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "3 Dashboards", packPrice: 225, packDaysToMake: 2, desc: "Up to 3 sources", features: ["DAX measures"] },
            premium: { title: "Suite", packPrice: 300, packDaysToMake: 1, desc: "Full report", features: ["Row-level security", "Training"] }
        },
        owner: {
            _id: "dataU1",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Up to 5k", packPrice: 90, packDaysToMake: 1, desc: "JavaScript sites", features: ["JSON", "Pagination"] },
            premium: { title: "10k+", packPrice: 120, packDaysToMake: 1, desc: "Complex auth", features: ["API", "Scheduler"] }
        },
        owner: {
            _id: "dataU2",
            fullname: "Maaz",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Pro", packPrice: 75, packDaysToMake: 1, desc: "Up to 25k", features: ["Null handling", "Logs"] },
            premium: { title: "Big", packPrice: 100, packDaysToMake: 1, desc: "50k+", features: ["Schema design"] }
        },
        owner: {
            _id: "dataU3",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "3 queries", packPrice: 128, packDaysToMake: 1, desc: "Aggregations", features: ["PostgreSQL"] },
            premium: { title: "Full set", packPrice: 170, packDaysToMake: 1, desc: "Procedure/CTE", features: ["MS-SQL", "Docs"] }
        },
        owner: {
            _id: "dataU4",
            fullname: "Ghyaas K",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "5 Photos", packPrice: 38, packDaysToMake: 1, desc: "Color grade", features: ["Dodge & burn"] },
            premium: { title: "10 Photos", packPrice: 50, packDaysToMake: 1, desc: "Full edit", features: ["Background cleanup"] }
        },
        owner: {
            _id: "photoU1",
            fullname: "Katy M",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "10 Images", packPrice: 270, packDaysToMake: 4, desc: "Styled props", features: ["PSD"] },
            premium: { title: "20 Images", packPrice: 360, packDaysToMake: 3, desc: "Lifestyle scene", features: ["Location"] }
        },
        owner: {
            _id: "photoU2",
            fullname: "Jakob M",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "Advanced", packPrice: 60, packDaysToMake: 1, desc: "Medium damage", features: ["Colorise"] },
            premium: { title: "Premium", packPrice: 80, packDaysToMake: 1, desc: "Severe damage", features: ["Print ready"] }
        },
        owner: {
            _id: "photoU3",
            fullname: "Muccitas",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "40 Pages", packPrice: 90, packDaysToMake: 2, desc: "Print ready", features: ["Layout", "CMYK"] },
            premium: { title: "Hardcover", packPrice: 120, packDaysToMake: 1, desc: "Printed book", features: ["Shipping"] }
        },
        owner: {
            _id: "photoU4",
            fullname: "Alvin T",
    ...
    },
    {
        ...
        packages: {
            ...
            standard: { title: "3 Poses", packPrice: 135, packDaysToMake: 1, desc: "Multiple outfits", features: ["Retouch", "Color grade"] },
            premium: { title: "5 Poses", packPrice: 180, packDaysToMake: 1, desc: "Studio quality", features: ["Background swap"] }
        },
        owner: {
            _id: "photoU5",
