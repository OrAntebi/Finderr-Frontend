...
export function GigDetails() {
    ...
    const renderMainContent = () => (
        <>
            ...
            {screenWidth < 964 && gig?.packages && <PricingPackages gig={gig} screenWidth={screenWidth} icons={icons} />}
    ...
    return (
        <section className={`gig-details${screenWidth < 964 ? ' full main-container' : ''}`}>
            ...
            {screenWidth >= 964 && gig?.packages && (
                <PricingPackages gig={gig} screenWidth={screenWidth} icons={icons} />
            )}
            <dialog className="modal-payment flex column">
                <div className="modal-title flex align-center justify-between">
                    ...
                    <button className="close-modal-btn"><img src={icons.close} alt="close-icon" /></button>
                </div>
